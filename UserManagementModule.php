...
namespace uzzielpelawak\modules\UserManagement;
...
class UserManagementModule extends \yii\base\Module
{
	 ...
	 * @var string
	 */
	public $registrationFormClass = 'uzzielpelawak\modules\UserManagement\models\forms\RegistrationForm';
	...
	public $controllerNamespace = 'uzzielpelawak\modules\UserManagement\controllers';
	...
	public static function t($category, $message, $params = [], $language = null)
	{
		if ( !isset(Yii::$app->i18n->translations['modules/user-management/*']) )
		{
			Yii::$app->i18n->translations['modules/user-management/*'] = [
				...
				'sourceLanguage' => 'en',
				'basePath'       => '@vendor/uzzielpelawak/module-user-management/messages',
				'fileMap'        => [
